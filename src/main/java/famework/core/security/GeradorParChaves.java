...
class GeradorParChaves
{
	 ...
	 * 
	 * @param fPub
	 *            O arquivo que irá conter a chave pública.
	 * @param fPvk
	 *            O arquivo que irá conter a chave privada.
	 * @throws IOException
	 *             Problemas de acesso/gravação do arquivo.
	 * @throws NoSuchAlgorithmException
	 *             RSA não disponível nesta versão do JDK.
